 ...
 *   https://datatables.net/download/#bs5/dt-1.11.3/fh-3.2.0/r-2.2.9/sc-2.0.5/sp-1.4.0
 *
 * Included libraries:
 *   DataTables 1.11.3, FixedHeader 3.2.0, Responsive 2.2.9, Scroller 2.0.5, SearchPanes 1.4.0
 */
...
(function( $, window, document, undefined ) {
	...
	DataTable.ext = _ext = {
		 ...
		 *  @type string
		 */
		build:"bs5/dt-1.11.3/fh-3.2.0/r-2.2.9/sc-2.0.5/sp-1.4.0",
